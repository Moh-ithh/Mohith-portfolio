...
export function DeveloperTerminal() {
  return (
    <Section id="terminal" spacing="standard" className="bg-background relative overflow-hidden border-t border-border/20">
      ...
      <Container variant="wide" className="flex flex-col gap-10 sm:gap-12 relative z-10">
        ...
        <div className="flex flex-col gap-3 max-w-2xl">
          ...
          >
            Query my credentials, specializations, and projects directories via a simulated local developer shell terminal.
          </Typography>
        </div>
